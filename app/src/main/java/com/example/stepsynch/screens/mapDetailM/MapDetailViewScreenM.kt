...
import com.example.stepsynch.screens.mapDetailM.LandmarkDetailDialogM
import com.example.stepsynch.screens.mapDetailM.LandmarkNodeM
import com.example.stepsynch.screens.mapDetailM.MapDetailBottomStatsM
import com.example.stepsynch.screens.mapDetailM.MapDetailHeaderM
...
fun MapDetailViewScreenM (
    ...
    val landmarks = remember {
        mutableStateListOf(
            ...
            Landmark(2, "Alpine Meadow", true, 0.50f, 0.40f),
            ...
            Landmark(6, "Mountain Lake", true, 0.15f, 0.75f),
            Landmark(7, "Pine Grove", true, 0.50f, 0.15f),
            Landmark(8, "Rocky Outcrop", true, 0.65f, 0.80f),
        )
    }
