...
//import com.example.stepsynch.screens.mapDetail.LandmarkDetailDialog
//import com.example.stepsynch.screens.mapDetail.LandmarkNode
//import com.example.stepsynch.screens.mapDetail.MapDetailBottomStats
//import com.example.stepsynch.screens.mapDetail.MapDetailHeader
////import com.example.stepsynch.screens.mapDetail.PlayerIndicator
//
//@Composable
//fun MapDetailViewScreenD(
...
//        mutableStateListOf(
//            Landmark(1, "Art Gallery", false, 0.20f, 0.30f),
//            Landmark(2, "Central Park", false, 0.50f, 0.40f),
//            Landmark(3, "City Hall", false, 0.70f, 0.25f),
//            Landmark(4, "Coffee Shop", false, 0.35f, 0.60f),
//            Landmark(5, "Fountain Square", false, 0.75f, 0.65f),
//            Landmark(6, "Historic Monument", false, 0.15f, 0.75f),
//            Landmark(7, "Shopping District", false, 0.50f, 0.15f),
//            Landmark(8, "Theater", false, 0.65f, 0.80f),
//        )
//    }
//
//    fun collectLandmark() {
...
fun MapDetailViewScreenD(
    ...
    fun collectLandmark() {
        ...
        // 4️⃣ Sync DB → UI + completion check
