...
class MapViewModel : ViewModel(){
    ...
    val regions = listOf(
        ...
        Region(5, "City Center", 1500, 20000, RegionType.CITY, RegionStatus.LOCKED, 0, 0.30f, 0.40f),
        Region(6, "Forest Grove", 1500, 20000, RegionType.NATURE, RegionStatus.LOCKED, 0, 0.50f, 0.40f),
        Region(7, "Harbor District", 2000, 30000, RegionType.CITY, RegionStatus.LOCKED, 0, 0.70f, 0.40f),
        Region(8, "Sky Gardens", 2500, 50000, RegionType.NATURE, RegionStatus.LOCKED, 0, 0.35f, 0.25f),
        Region(9, "Ancient Ruins", 3000, 75000, RegionType.NATURE, RegionStatus.LOCKED, 0, 0.65f, 0.25f),
        Region(10, "Summit Peak", 5000, 100000, RegionType.NATURE, RegionStatus.LOCKED, 0, 0.50f, 0.10f)
    )
